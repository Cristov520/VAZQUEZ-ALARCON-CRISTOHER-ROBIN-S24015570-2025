...
public class Proyecto {
    ...
    static  boolean registro = false; //Centinela para saber si ya se registraron los trabajadores
    ...
    public static void mostrarMenu() {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    if (registro) {
                        System.out.print("Ya se han registrado los trabajadores, estas seguro que desea sobrescribir los datos? (s/n): ");
                        char respuesta = input.nextLine().charAt(0);
                        if (respuesta == 's' || respuesta == 'S') {
                            darDeAlta(trabajadores);
                        } else {
                            System.out.println("Registro de trabajadores cancelado");
                            break;
                        }
                    } else {
                    darDeAlta(trabajadores);
